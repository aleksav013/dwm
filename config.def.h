...
static const char *fonts[]          = { "monospace:size=10:autohint=true:antialias=true", "JoyPixels:pixelsize=10:autohint=true:antialias=true", };
...
static const Key keys[] = {
	...
	{ 0, XF86XK_AudioPrev,		spawn, 	SHCMD("/usr/bin/mpc --port=6601 prev") },
	{ 0, XF86XK_AudioPlay,		spawn, 	SHCMD("/usr/bin/mpc --port=6601 toggle") },
	{ 0, XF86XK_AudioNext,		spawn, 	SHCMD("/usr/bin/mpc --port=6601 next") },
